...
export function OAuthSignIn({ callbackUrl }: OAuthSignInProps) {
  ...
  const handleGitHubSignIn = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    ...
    <div className="grid grid-cols-2 gap-4">
      <form onSubmit={handleGoogleSignIn}>
        ...
        <Button
          type="submit"
          variant="outline"
          className="w-full flex items-center justify-center cursor-pointer py-5 border-border hover:bg-muted/50"
